package com.main.ezipsmsclient;
...
public class SMSClient {
    ...
    private String url ="http://bulksms.eduezip.com/rest/services/sendSMS/sendGroupSms";
    ...
    public String getUrl(String AuthKey, String Message, String SenderId, String PhoneNumber, String RouteId, String SMSContentType){
        ...
        if (SMSContentType.equals("english") || SMSContentType.equals("unicode")){
            try {
                SMSURL = "http://bulksms.eduezip.com/rest/services/sendSMS/sendGroupSms"+param1+URLEncoder.encode(AuthKey,"UTF-8")
            ...
            Toast.makeText(context ,"SMSContentType should either be 'enlgish' or 'unicode' ", Toast.LENGTH_SHORT).show();
        }
